classdef SymphonyUI < handle
    ...
    methods
        ...
        function obj = SymphonyUI(symphonyConfig)
            ...
            obj.userData = symphonyConfig.userData;
        ...
        function showRigConfigurationDescription(obj, ~, ~)
            ...
            msgbox([obj.rigConfig.displayName ':' char(10) char(10) desc], 'Rig Configuration', 'modal');
        end
        ...
        function showMainWindow(obj)
            if ~isempty(obj.mainWindow)
                ...
                obj.controls.notSavingEpochsText = uicontrol(...
                    ...
                    'Position', [85 109 270 19], ...
                    'BackgroundColor', bgColor, ...
                    'ForegroundColor', 'red', ...
                    'Visible', 'off', ...
                    'String', 'Epoch data not being saved', ...
                    'Style', 'text', ...
        ...
        function updateUIState(obj, varargin)
            ...
            savingEpochs = ~isempty(obj.protocol) && ~isempty(obj.epochGroup) && ...
                           get(obj.controls.saveEpochsCheckbox, 'Value') == get(obj.controls.saveEpochsCheckbox, 'Max');
        ...
        function closeRequestFcn(obj, ~, ~)
            ...
            %if Stage Protocol set the LightCrafter to OFF
            if isa(obj.protocol, 'StageProtocol')
                obj.protocol.stage.connect();
                obj.protocol.stage.setLcrPatternAttributes(8, 'none', 1);
                obj.protocol.stage.disconnect();
            end

    ...
    methods
        ...
        function prepareRun(obj)
            ...
            if ~DEMO_MODE
                ...
                obj.openFigure('Mean Response', obj.amp, 'GroupByParams', {'holdSignal'}, 'StartTime', obj.stimStart, 'EndTime', obj.stimEnd);
        ...
        function prepareEpoch(obj, epoch)
            ...
            epoch.addParameter('holdSignal', obj.ampHoldSignal);
            
            %set the hold signal for this epoch
